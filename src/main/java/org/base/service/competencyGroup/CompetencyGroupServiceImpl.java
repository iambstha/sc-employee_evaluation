...
public class CompetencyGroupServiceImpl implements CompetencyGroupService {
    ...
    private static final List<String> ALLOWED_SORT_COLUMNS = List.of("competencyGroupId","weightage");
    ...
    @Override
    public List<CompetencyGroupResDto> getPaginated(int page, int size, String sortDirection, String sortColumn) {
        try {
            ...
            return  competencyGroupRepository
